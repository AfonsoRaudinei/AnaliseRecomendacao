...
const dadosRegenciaGrupo = {
    autor: [
        ...
        { value: 'raij', label: 'Raij et al. (1997)' },
        { value: 'sousa', label: 'Sousa & Lobato (2004)' },
        { value: 'novais', label: 'Novais et al. (2007)' },
        { value: 'embrapa', label: 'Embrapa (2013)' }
    ],
    tecnologia: [
        { value: 'convencional', label: 'Convencional' },
        { value: 'intacta', label: 'Intacta RR2' },
        { value: 'enlist', label: 'Enlist E3' },
        { value: 'xtend', label: 'XtendFlex' },
        { value: 'liberty', label: 'Liberty Link' }
    ],
    cultivar: [
        { value: 'tmg7062', label: 'TMG 7062' },
        { value: 'ns7709', label: 'NS 7709' },
        { value: 'm8644', label: 'M 8644' },
        { value: 'as3730', label: 'AS 3730' },
        { value: 'bmx', label: 'BMX Potência' }
    ]
};
